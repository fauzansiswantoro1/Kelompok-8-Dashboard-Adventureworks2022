...
<head>
    ...
    <title>ADVENTUREWORKS2022 - Finance</title>
...
<body id="page-top">
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT SUM(linetotal) as total_pendapatan from sales_fact";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT COUNT(customer_id) as jumlah_transaksi from sales_fact";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Pendapatan Tahun Lalu
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                    ...
                                    <div class="chart-area-store">
                                        ...
                                        <?php
                                            ...
                                            while($row = mysqli_fetch_array($tahun)){
                                                ...
                                                $query = mysqli_query($mysqli,"SELECT SUM(fp.linetotal) as total, t.tahun FROM sales_fact fp JOIN time t ON fp.time_id=t.time_id WHERE tahun='".$row['tahun']."' GROUP BY tahun");
    ...
    <script type="text/javascript">
        ...
        $amount = "SELECT SUM(f.linetotal) amount FROM sales_fact f JOIN time t ON f.time_id=t.time_id GROUP BY t.bulan ORDER BY t.tanggallengkap";
        $i=1;
