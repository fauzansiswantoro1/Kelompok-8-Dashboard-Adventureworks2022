...
<head>
    ...
    <title>ADVENTUREWORKS2022 - Logistic</title>
...
<body id="page-top">
                                        ...
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ...
                                                <?php  
                                                 ...
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                                    ...
                                                    $sql = "SELECT COUNT(ship_id) as jumlah_cust from shipment";
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Pengiriman yang Sudah Dilakukan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 $host       = "localhost";
                                                 $user       = "root";
                                                 ...
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                                    ...
                                                    $sql = "SELECT COUNT(shipment_id) as jumlah_cust from shipment_fact";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['jumlah_cust'],0,".",",");
                                                        }
                        ...
                        <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Pengeluaran dari Pengiriman</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 $host       = "localhost";
                                                 $user       = "root";
                                                 ...
                                                 $sql = "SELECT SUM(freight) as total_pendapatan from shipment_fact";
                                                 $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                        ...
                        <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Pengeluaran dari Pajak Pengiriman</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 $host       = "localhost";
                                                 $user       = "root";
                                                 ...
                                                 $sql = "SELECT SUM(taxamt) as total_pendapatan from shipment_fact";
                                                 $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo "$".number_format($row2['total_pendapatan'],0,".",",");
                                                 }
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Jumlah Pengeluaran Setiap Bulan Pengiriman XRQ DAN CARGO TRANSPORT 5</h6>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Pengeluaran Biaya Logistic Pengiriman Berdasarkan Bulan</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body-store">
                                    <div class="chart-area-store">
                                        ...
                                        $sql = "SELECT SUM(freight) AS total FROM shipment_fact";
                                        $tot = mysqli_query($mysqli, $sql);
                                        $tot_amount = mysqli_fetch_row($tot);

                                        // Query Data Store dan Total Amountnya
                                        $sql = "SELECT CONCAT('name:',s.shipmethod_name) as name, CONCAT('y:', SUM(fp.freight)*100/" . $tot_amount[0] .") as y, CONCAT('drilldown:', s.shipmethod_name) as drilldown 
                                        FROM shipment s 
                                        JOIN shipment_fact fp ON (s.ship_id = fp.shipment_id) 
                                        GROUP BY name 
                                        ORDER BY y DESC";
                                        ...
                                        $sql = "SELECT s.shipmethod_name nama_kota, sum(fp.freight) as tot_kat
                                        FROM shipment_fact fp
                                        JOIN shipment s ON (s.ship_id = fp.shipment_id)
                                        GROUP BY nama_kota";
                                        ...
                                        $sql = "SELECT s.shipmethod_name nama_kota, t.bulan as bulan, SUM(fp.freight) as pendapatan_kat
                                        FROM shipment s
                                        JOIN shipment_fact fp ON (s.ship_id = fp.shipment_id)
    ...
    // Create the chart
        ...
        title: {
            text: 'Persentase Nilai Biaya Transportasi Logistic Adventureworks2022 - Berdasarkan Jenis Pengiriman'},
            subtitle: {
                text:'Klik di potongan kue untuk melihat detil nilai pengeluaran logistic per jenis pengiriman berdasarkan bulan'
            },
            accessibility: {
                announceNewData: {
                    enabled: true
            ...
            series: [
                {
                    name: "Pengeluaran By Jenis Pengiriman",
                    colorByPoint: true,
                    data:
                        <?php
    ...
    <script type="text/javascript">
        ...
        $bulan = "SELECT CONCAT(MONTHNAME(t.tanggallengkap), ' ', YEAR(t.tanggallengkap)) bulan FROM shipment_fact f JOIN time t ON f.time_id=t.time_id GROUP BY t.bulan ORDER BY t.tanggallengkap";
        $amount = "SELECT count(fp.product_id) as amount FROM shipment s JOIN shipment_fact fp ON (s.ship_id = fp.shipment_id) JOIN time t ON (t.time_id = fp.time_id) GROUP BY s.shipmethod_name, t.bulan HAVING s.shipmethod_name='XRQ - TRUCK GROUND'";
        $amount1 = "SELECT count(product_id) as amount FROM shipment s JOIN shipment_fact fp ON (s.ship_id = fp.shipment_id) JOIN time t ON (t.time_id = fp.time_id) GROUP BY s.shipmethod_name, t.bulan HAVING s.shipmethod_name='CARGO TRANSPORT 5'";
        $i=1;
