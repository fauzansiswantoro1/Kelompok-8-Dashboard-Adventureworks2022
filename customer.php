...
<head>
    ...
    <title>ADVENTUREWORKS2022 - Customer</title>
...
<body id="page-top">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT COUNT(DISTINCT(f.customer_id)) customer FROM sales_fact f JOIN time t ON f.time_id=t.time_id WHERE t.tahun=2003";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    ...
                                                    <?php
                                                    $sql = "SELECT COUNT(DISTINCT(f.customer_id)) customer FROM sales_fact f JOIN time t ON f.time_id=t.time_id WHERE t.tahun=2004";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['customer'],0,".",",");
                                                        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Jumlah Customer Berdasarkan Territory </h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    <div class="chart-area">
                                        ...
                                        <?php
                                            ...
                                            $lamapinjam = mysqli_query($mysqli,"SELECT DISTINCT(territory_id), COUNT(customer_id) as customer_id FROM sales_fact WHERE territory_id IS NOT NULL AND territory_id > 0 GROUP BY territory_id ORDER BY customer_id DESC");
                                            while($row = mysqli_fetch_array($lamapinjam)){
                                                $jenis_lamapinjam[] = $row['territory_id'];

                                                $query = mysqli_query($mysqli,"SELECT COUNT(customer_id) as customer_id FROM sales_fact WHERE territory_id IS NOT NULL AND territory_id > 0 AND territory_id='".$row['territory_id']."'");
    ...
    <script type="text/javascript">
        ...
        $customer = "SELECT COUNT(f.customer_id) customer FROM sales_fact f JOIN time t ON f.time_id=t.time_id GROUP BY t.bulan ORDER BY t.tanggallengkap";
        $i=1;
