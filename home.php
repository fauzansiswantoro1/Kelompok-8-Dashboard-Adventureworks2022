...
<head>
    ...
    <title>ADVENTUREWORKS2022 - Dashboard</title>
...
<body id="page-top">
 ...
 <!-- Topbar -->
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Product yang Dijual</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                    $sql = "SELECT COUNT(product_id) as jumlah_film from product";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                    ...
                    <div class="row">
                        <iframe name="mondrian" src="http://localhost:8080/mondrian/" style="height:700px; width:100%; border:none; align-content:center"> </iframe>
                        
                </div>

                <div class="row">
                        <iframe name="our-team" src="http://localhost/uasdwo/our-team.php" style="height:1000px; width:100%; border:none; align-content:center"> </iframe>
